abstract class AppStrings
{
  ...
  static String signupScreenRoute="/signupScreenRoute";
    ...
    // Admin
  static String adminHomeScreenRoute="/adminHomeScreenRoute";

    // Driver
  static String driverHomeScreenRoute="/driverHomeScreenRoute";
  ...
  // Pharmacy
  static String pharmacyHomeScreenRoute="/pharmacyHomeScreenRoute";
  // Market
  static String marketHomeScreenRoute="/marketHomeScreenRoute";
  // Wsly
  static String wslyHomeScreenRoute="/wslyHomeScreenRoute";


    // User
  static String userMainScreenRoute="/userMainScreenRoute";
  static String userHistoryScreenRoute="/userHistoryScreenRoute";
